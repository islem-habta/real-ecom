...
const PaymentForm = () => {
  ...
  const submitPaymentForm: SubmitHandler<PaymentFormInputs> = (formInput) => {
    // Intentionally left blank for demo; submit payment using formInput
    console.log("Payment form submitted:", formInput);
  };
